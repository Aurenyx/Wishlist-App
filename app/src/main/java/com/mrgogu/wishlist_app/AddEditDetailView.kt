...
fun AddEditDetailView(
    ...
    Scaffold(
        topBar = {
            ...
            ) // Here we take care of Back buttons navigation to the back button
    {
        Column(
            modifier = Modifier.padding(it).fillMaxSize().background(color = Color(0xFFFCECDD)),
            horizontalAlignment = Alignment.CenterHorizontally,
            verticalArrangement = Arrangement.Top
        ) {
           // Space btw top bar and Outlinedtextfields
            ...
            }, colors = ButtonDefaults.buttonColors(containerColor = Color(0xFFFF7B00), contentColor = Color(0xFFFFE3BB)))
            {
                Text(
